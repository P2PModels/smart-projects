        ...
        return new Promise((resolve, reject) => {
            ...
            setTimeout(() => {
                ...
                if (url.endsWith('/projects') && opts.method === 'POST') {
                    ...
                    // save new project
                    newProject.id = users.length ? Math.max(...projects.map(project => project.id)) + 1 : 1;
                    ...
                    if (opts.headers && opts.headers.Authorization === 'Bearer fake-jwt-token') {
                        ...
                        for (let i = 0; i < projects.length; i++) {
                            ...
                            if (project.id === id) {
                                ...
                                projects[i].participants = projects[i].participants.filter(p => p !== params.removeParticipant)
