...
function addParticipant(project, user) {
    ...
    function request(project, user) { return { type: projectConstants.ADD_PARTICIPANT_REQUEST, project, user } }
    function success(project, user) { return { type: projectConstants.ADD_PARTICIPANT_SUCCESS, project, user } }
    function failure(error) { return { type: projectConstants.ADD_PARTICIPANT_FAILURE, error } }
}
...
function removeParticipant(project, user) {
    return dispatch => {
        ...
        projectService.removeParticipant(project, user)
            .then(
                _project => {
                    dispatch(success(project, user));
                    //history.push('/login');
    ...
    function request(project, user) { return { type: projectConstants.REMOVE_PARTICIPANT_REQUEST, project, user } }
    function success(project, user) { return { type: projectConstants.REMOVE_PARTICIPANT_SUCCESS, project, user } }
    function failure(error) { return { type: projectConstants.REMOVE_PARTICIPANT_FAILURE, error } }
}
